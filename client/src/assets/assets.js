...
export const ownerMenuLinks = [
    ...
    { name: "Add car", path: "/owner-dashboard/add-car", icon: addIcon, coloredIcon: addIconColored },
      { name: "Car Management", path: "/owner-dashboard/car-manage", icon: carIcon, coloredIcon: carIconColored },
    ,
    { name: "Manage Bookings", path: "/owner-dashboard/manage-bookings", icon: listIcon, coloredIcon: listIconColored },
